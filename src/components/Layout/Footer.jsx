    ...
    <footer class="md:pt-[100px]">
      <div className="bg-secondary text-white  p-10">
        <div class="container mx-auto py-8 px-4 lg:px-8">
          ...
          <div className="mb-5">
            ...
            <p className="text-baseColor text-sm">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              <p class="text-sm text-justify text-baseColor  text-sm">
            ...
            <div>
              ...
              <p class="text-sm text-baseColor ">
                Address: House# 74, Road# 127, Gulshan Avenue, Dhaka, Bangladesh
              </p>
              <p class="text-sm text-baseColor">Phone: (+880) 1777777777</p>
              <p class="text-sm text-baseColor">
                Email: selectron.info@gmail.com
              </p>
            </div>
            ...
            <div>
              ...
              <ul class="text-sm">
                <li>
                  <a
                    href="#"
                    class="text-baseColor hover:text-gray-400  text-sm"
                  >
                    Gaming PCs
                  </a>
                </li>
      ...
      <div className="bg-subsidery text-white">
        <div className="md:container md:px-[100px] py-5">
          <div className="flex flex-row justify-around text-baseColor items-center ">
